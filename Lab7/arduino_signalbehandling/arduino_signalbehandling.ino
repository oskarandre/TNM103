...
void loop()
{
  ...
  // float overdrive = ((soundSampleFromADC)*(badc1/5))/4;


  // //float overdrive=soundSampleFromADC*(badc1/4.0);

  // if(overdrive > 127) overdrive = 127;
  // if(overdrive < -126)overdrive = -126;

  // overdrive+=127;

  // sramBufferSampleValue = ((overdrive));
  ...
  // sramBufferSampleValue = ((sramBuffer[bufferIndex]-127) + (sramBuffer[bufferIndex2]-127) +127)/2;
  ...
  sramBufferSampleValue = 127-soundSampleFromSramBuffer;

  sramBufferSampleValue = sramBufferSampleValue*map(badc1,0,240, 1, 255)/255;

  soundSampleFromADC = badc0-127;

  soundSampleFromADC= (soundSampleFromADC+sramBufferSampleValue);
